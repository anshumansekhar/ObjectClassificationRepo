...
public class ImageClassifier {
  ...
  ImageClassifier(Activity activity) throws IOException {
    LABEL_PATH="retrained_labels_"+CameraActivity.code+".txt";
  ...
  private List<String> loadLabelList(Activity activity) throws IOException {
    ...
    conf.setLocale(new Locale(CameraActivity.code));
    Context localizedContext = activity.createConfigurationContext(conf);
    labelList= Arrays.asList(localizedContext.getResources().getStringArray(R.array.labels));
